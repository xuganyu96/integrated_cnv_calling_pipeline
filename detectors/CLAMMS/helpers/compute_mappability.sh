...
echo "This computer has a maximum of ${max_n_core} cores; default to use all of them"
...
echo "Indexing reference genome at ${index_inputs_path} using ${max_n_core} cores and outputing to ${index_output_path}"
gem-indexer -i ${index_input_path} \
-c "dna" \
-T ${max_n_core} \
-o ${index_output_path_prefix}
# Print a confirmation message for completing the indexing
echo "Indexing completed; listing files in ./detectors_inputs/CLAMMS/no_prefix_genome"
...
echo "Computing mappability for the reference genome using ${max_n_core} cores and outputingto main/detectors_inputs/CLAMMS/mappability.gem"
...
echo "Converting mappability result at main/detectors_inputs/CLAMMS/mappability using index at main/detectors_inputs/CLAMMS/no_prefix_genom/no_prefix.fasta.gem and outputing to main/detectors_inputs/CLAMMS/mappability.wig"
...
-o ./detectors_inputs/CLAMMS/mappability
echo "Mappability wig output to ./detectors_inputs/CLAMMS/mappability.wig"
